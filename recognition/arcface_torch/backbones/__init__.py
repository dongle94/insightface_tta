...
from .iresnet_topo import iresnet50_t, iresnet100_t, iresnet200_t
...
def get_topo_model(name, **kwargs):
    # resnet
    if name == "r18":
        return iresnet18(False, **kwargs)
    elif name == "r34":
        ...
        return iresnet50_t(False, **kwargs)
    elif name == "r100":
        return iresnet100_t(False, **kwargs)
    elif name == "r200":
        return iresnet200_t(False, **kwargs)
    elif name == "r2060":
        from .iresnet2060 import iresnet2060
        return iresnet2060(False, **kwargs)
