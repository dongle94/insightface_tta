...
class IResNet(nn.Module):
    ...
    def forward(self, x, phase='train'):
        ...
        if phase != 'infer':
            with torch.amp.autocast('cuda', torch.half):
...
def iresnet50_t(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet50', IBasicBlock, [3, 4, 14, 3], pretrained,
                    progress, **kwargs)


def iresnet100_t(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet100', IBasicBlock, [3, 13, 30, 3], pretrained,
                    progress, **kwargs)


def iresnet200_t(pretrained=False, progress=True, **kwargs):
